...
document.documentElement.classList.remove("no-js");var STORAGE_KEY="user-color-scheme",COLOR_MODE_KEY="--color-mode",modeToggleButton=document.querySelector(".js-mode-toggle"),modeStatusElement=document.querySelector(".js-mode-status");function getCSSCustomProp(e){var t=getComputedStyle(document.documentElement).getPropertyValue(e);return t.length&&(t=t.replace(/\"/g,"").trim()),t}function applySetting(e){var t=e||localStorage.getItem(STORAGE_KEY);t?(document.documentElement.setAttribute("data-user-color-scheme",t),modeStatusElement.innerText='Color mode is now "'+t+'"'):modeStatusElement.innerText='Color mode is now "'+getCSSCustomProp(COLOR_MODE_KEY)+'"'}function toggleSetting(){var e=localStorage.getItem(STORAGE_KEY);switch(e){case null:e="dark"===getCSSCustomProp(COLOR_MODE_KEY)?"light":"dark";break;case"light":e="dark";break;case"dark":e="light"}return localStorage.setItem(STORAGE_KEY,e),e}modeToggleButton.addEventListener("click",function(e){e.preventDefault(),applySetting(toggleSetting())}),applySetting();